...
def winc_river(boardcards, holecards, exclude=[]):
    ...
    resetcards = possiblecards(boardcards + holecards + exclude, ALLCARDS)
    opponentholecards = itertools.combinations(resetcards, 2)
...
def winc_turn(boardcards, holecards, exclude=[]):
    ...
    resetcards = possiblecards(boardcards + holecards + exclude, ALLCARDS)
    restboardcard = itertools.combinations(resetcards, 1)
    wincount, tiecount, totalcount = 0,0,0
